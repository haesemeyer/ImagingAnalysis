...
class Ui_StackAnalyzer(object):
    def setupUi(self, StackAnalyzer):
        ...
        self.label_11.setGeometry(QtCore.QRect(10, 110, 131, 16))
        self.label_11.setObjectName(_fromUtf8("label_11"))
        self.tbMinPhot = QtGui.QLineEdit(self.groupBox_2)
        self.tbMinPhot.setGeometry(QtCore.QRect(140, 110, 51, 20))
        self.tbMinPhot.setObjectName(_fromUtf8("tbMinPhot"))
        ...
        self.segColView = ImageView(self.corTab)
        ...
        self.graphNHist = PlotWidget(self.nucTab)
        self.graphNHist.setGeometry(QtCore.QRect(10, 50, 541, 111))
        self.graphNHist.setObjectName(_fromUtf8("graphNHist"))
    ...
    def retranslateUi(self, StackAnalyzer):
        ...
        self.label_11.setText(_translate("StackAnalyzer", "Min. photons/pixel/frame", None))
